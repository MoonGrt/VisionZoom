...
Processing speed and latency: Another very important indicator for the evaluation of video streaming is the smoothness of the picture. The latency of the VisionZoom Pro system is imperceptible to the naked eye, and the measured frame rates are 60Hz under ideal conditions.
